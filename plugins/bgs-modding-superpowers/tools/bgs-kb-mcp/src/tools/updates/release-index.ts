...
async function fetchJson(url: string, opts: { fetchImpl: typeof fetch; timeoutMs: number }): Promise<unknown> {
...
export async function fetchReleaseIndex(options: ReleaseIndexFetcherOptions = {}): Promise<ReleaseIndex> {
