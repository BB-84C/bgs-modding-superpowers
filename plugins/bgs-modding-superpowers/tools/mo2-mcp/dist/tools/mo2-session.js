...
import { bindingSnapshot } from "../binding.js";
...
registerTool({
    name: "mo2_session",
    tier: "T1",
    description: "Inspect or change the MO2 MCP lazy binding. Call with no args to inspect, {mo2Root, profile?} to bind/rebind, or {unbind:true} to unbind.",
    inputSchema,
