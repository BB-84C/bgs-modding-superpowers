    ...
    groups: [
        ...
        },
        {
            ...
            commands: [
                ...
                { name: "files.get", summary: "Per-file summary", mutating: false, keyArgs: ["name"] },
                { name: "files.create", summary: "New plugin", mutating: true, keyArgs: ["fileName", "template", "flags", "initialMasters"] },
                { name: "files.add_required_masters", summary: "Add masters to a plugin", mutating: true, keyArgs: ["targetFile", "source"] },
                ...
                { name: "files.set_header_flags", summary: "ESM/ESL/medium flag toggle", mutating: true, keyArgs: ["file", "flags"] },
...
export function allDigestCommands() {
    return CAPABILITIES_DIGEST.groups.flatMap((g) => g.commands.map((c) => c.name));
}
//# sourceMappingURL=capabilities-digest.js.map