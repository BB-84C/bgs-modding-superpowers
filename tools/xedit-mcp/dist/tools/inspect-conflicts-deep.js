...
export function makeInspectConflictsDeepHandler(opts) {
    return async (args) => {
        ...
        const p = precheck({ tool: "xedit_inspect_conflicts_deep", args }, { ctx, needs: { daemon: true } });
        if (p) {
        ...
        const { includeReferences: _drop, ...coreArgs } = daemonArgs;
        const calls = [
...
//# sourceMappingURL=inspect-conflicts-deep.js.map